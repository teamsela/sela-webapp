...
export const StropheBlock = ({
    ...
    const [expanded, setExpanded] = useState(stropheProps.metadata?.expanded !== undefined ? stropheProps.metadata.expanded : true);
    ...
    const handleCollapseBlockClick = () => {
      ...
      // if (!ctxInViewMode) {
      //   updateStropheState(ctxStudyId, stropheProps.stropheId, !expanded && stanzaExpanded);
      // }
      if (expanded) {
