...
export default function ScripturaTable({
  ...
  useEffect(() => {
    const fetchStudies = async () => {
      try {
        const result = await fetchScripturaStudies(query, currentPage, sortKey, sortAsc);
