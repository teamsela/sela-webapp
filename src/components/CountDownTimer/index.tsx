...
const CountDownTimer: React.FC = () => {
  ...
  const targetDate = new Date("2025-01-17T19:00:00");
      ...
      <div>
        <div className="mb-3 flex items-center gap-2">
          {formatNumber(days).map((digit, index) => (
            ...
            >
              <span className="flex h-17.5 min-w-[56px] items-center justify-center rounded-lg bg-[#44403c] px-3 text-xl font-black leading-[1.35] text-white dark:bg-boxdark lg:text-3xl xl:text-[40px]">
                {digit}
              </span>
